<div class="my-4 w-full card px-12 md:w-2/3 {{ $visitorInReservation->contact ? 'border-4 border-red-200' : 'border-2' }}">
    ...
    <div class="float-right text-right">
        ...
        @else
            ...
            @endcan
        @endif
        <div class="p-1 border-4 text-center sm:p-2 md:p-4">
            <svg xmlns="http://www.w3.org/2000/svg" class="inline h-6 w-6 m-2 md:h-8 md:w-8 md:m-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
