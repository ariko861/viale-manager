                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><h3 class="underline text-gray-900 dark:text-white">{{__("Contactez nous")}}</h3></div>
                            </div>
                            @php
                                $text_class="mt-2";
                            @endphp
                            <div class="ml-12">
                                <div class="{{ $text_class }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline align-middle" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    <a class="align-middle" href="mailto:{{ $options->firstWhere('name', 'email')->value ?? ''}}">{{ $options->firstWhere('name', 'email')->value ?? ''}}</a>
                                </div>
                                <div class="{{ $text_class }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline align-middle" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l embed-responsive embed-responsive-16by9">
